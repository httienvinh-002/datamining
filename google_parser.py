# Sử dụng gói (module) icrawler, là một framwork nhỏ dùng cho việc cào dữ liệu hình ảnh từ web site Google Image
# Trước tiên thay đổi một chút ở class GoogleParser của gói (module) này để phù hợp với sự thay đổi của google hiện tại
import re
